...
function separator(word, length = 50) {
...
const habitos = ['5 AM', 'GYM', 'leer', 'aprender'];
// Otra forma de definirlo 
const personas = ['Juan', 'María', 'Pedro', 'Carlos'];
/*
-----------------------------------------------
------------- ARREGLOS CON NUMBERS ------------
-----------------------------------------------
*/
const edades = [654, 321, 987, 654, 321, 354, 159, 423];
const ids = [654, 321, 987, 321, 687, 215, 357, 963, 412];
/*
-----------------------------------------------
------------- ARREGLOS CON DIFERENTES TIPOS ------------
-----------------------------------------------
*/
const diferentes = ["Holaa", "Tengo", 19, "años"];
const otros = ["foo", 23, "Holap"];
/*
-----------------------------------------------
------------- RECORRIDO DE ARRAYS -------------
-----------------------------------------------
...
(function (Genero) {
    ...
    Genero[Genero["FEMENINO"] = 2] = "FEMENINO";
})(Genero || (Genero = {}));
let juan = { id: 1, nombre: "JUAN", edad: 15, genero: Genero.MASCULINO };
const atributosJuan = Object.entries(juan);
